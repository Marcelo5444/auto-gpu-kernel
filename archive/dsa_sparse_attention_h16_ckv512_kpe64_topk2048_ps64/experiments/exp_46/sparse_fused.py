...
def _fused_split_combine_kernel(
    ...
    tl.store(pm_ptrs, m_i, cache_modifier=".cg", eviction_policy="evict_last")
    tl.store(pl_ptrs, l_i, cache_modifier=".cg", eviction_policy="evict_last")
    tl.store(pacc_ptrs, acc, cache_modifier=".cg", eviction_policy="evict_last")
