"""
DSA TopK Indexer — Triton score + remap kernels (exp 12, REVERTED).

Bumped remap_kernel BLOCK_K from 256 to 1024 (4× fewer programs).
Result: systematic regression A/B 0/16 wins, mean Δ +0.0004 ms
(+0.8%). 1024 per-program is slower — likely register pressure or
the original 256 was already well-tuned for this tiny kernel.
Reverted.
"""
