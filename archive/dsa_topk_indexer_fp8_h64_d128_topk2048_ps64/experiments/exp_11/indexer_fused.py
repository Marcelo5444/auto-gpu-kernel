"""
DSA TopK Indexer — Triton score + remap kernels (exp 11, REVERTED).

Added num_warps=8 to score_kernel launch. Result: A/B 7/16 wins,
mean Δ +0.0001 ms (essentially tied); 30cecff1 (smallest workload)
regressed +12.79%. Reverted.
"""
